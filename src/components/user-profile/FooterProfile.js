  ...
  return (
    <div>
      <div className="border border-gray-300 mt-5 rounded-2xl px-10 py-5">
        ...
        <div>
            <h2 className="font-bold text-black font-avenir">Country / Region</h2>
            <p className="font-medium text-black font-work">{location}</p>
          </div>
          <div>
            <h2 className="font-bold text-black font-avenir">Address / Street</h2>
            <p className="font-medium text-black font-work">{address}</p>
          </div>
        </div>
          <div className='flex flex-row gap-10 mt-5'>
           <div>
            <h2 className="font-bold text-black font-avenir">State / Province</h2>
